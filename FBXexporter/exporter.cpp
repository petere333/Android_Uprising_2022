...
int main()
{
	...
	FbxScene* scene = LoadFbxSceneFromFile(manager, "/fbx/WoodenCableDrum.fbx");
	printf("FBX 파일 로딩 완료\n");
	...
	FILE* idxOut = fopen("result/idx_통신병PTSD.txt", "w");
	FILE* frameOut = fopen("result/vtx_통신병PTSD.txt", "w");

...
int main()
{
	...
	FbxScene* scene = LoadFbxSceneFromFile(manager, "/fbx/plastic_bin_a_01.fbx");
	printf("FBX 파일 로딩 완료\n");
	...
	FILE* idxOut = fopen("result/idx_그냥화물1.txt", "w");
	FILE* frameOut = fopen("result/vtx_그냥화물1.txt", "w");

...
int main()
{
	...
	FbxScene* scene = LoadFbxSceneFromFile(manager, "/fbx/Machine_4.fbx");
	printf("FBX 파일 로딩 완료\n");
	...
	FILE* idxOut = fopen("result/idx_잔해기계.txt", "w");
	FILE* frameOut = fopen("result/vtx_잔해기계.txt", "w");

...
int main()
{
	...
	FbxScene* scene = LoadFbxSceneFromFile(manager, "/fbx/SawBlade.fbx");
	printf("FBX 파일 로딩 완료\n");
	...
	FILE* idxOut = fopen("result/idx_톱날단검2.txt", "w");
	FILE* frameOut = fopen("result/vtx_톱날단검2.txt", "w");

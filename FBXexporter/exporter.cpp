...
int main()
{
	...
	FbxScene* scene = LoadFbxSceneFromFile(manager, "/fbx/plastic_drum_a_01.fbx");
	printf("FBX 파일 로딩 완료\n");
	...
	FILE* idxOut = fopen("result/idx_잔해드럼통.txt", "w");
	FILE* frameOut = fopen("result/vtx_잔해드럼통.txt", "w");

...
<<<<<<< HEAD
<<<<<<< HEAD
				// ¿ßø° ≥ªøÎ¿ª ¿œ¿œ¿Ã ¿Ã«ÿ«“ º¯ æ¯æÓµµ
				// ¿œ¥‹ »ÆΩ««—∞«, ¡¶æÓ¡° ¡¬«•, ¿Œµ¶Ω∫, uv, uv¿Œµ¶Ω∫øÕ ¥ı∫“æÓ
				// æ÷¥œ∏ﬁ¿Ãº«¿Ã ∆˜«‘µ» ∏µ®¿∫ Ω∫≈≤¿Œµ¶Ω∫, Ω∫≈≤ø˛¿Ã∆Æ, ≈¨∑ØΩ∫≈Õºˆ, ∫ªø¿«¡º¬∫Ø»Ø¿Ã∂Û¥¬ ≥◊∞°¡ˆ ∞™¿ª ¥ı∞°¡Æ.
				// ±◊∏Æ∞Ì ∏ﬁΩ¨∏¶ ∏∏µÈ ∂ß ¿Ã ≥◊∞°¡ˆ ¡§∫∏∏¶ ¡§¡° πˆ∆€ø° √ﬂ∞°«ÿ.
...
=======
=======
>>>>>>> parent of 83f8937 (ÏÉÅÌïòÏ¢åÏö∞Ïù¥Îèô Î∞è Ï£ºÏÑù)
				pFbxRenderInfo->m_pMesh = new CMeshFromFbx(pd3dDevice, pd3dCommandList, nVertices, pxmf4Vertices, uvs, nIndices, pnIndices, pnSkinningIndices, pfSkinningWeights, nClusters, pxmf4x4VertextToLinkNodes);

...
D3D12_GPU_DESCRIPTOR_HANDLE		CGameObject::m_d3dCbvGPUDescriptorHandle;
...
void CGameObject::UpdateShaderVariable(ID3D12GraphicsCommandList* pd3dCommandList, FbxAMatrix* pfbxf4x4World)
{
	...
	//pd3dCommandList->SetGraphicsRoot32BitConstants(3, 16, &xmf4x4World, 0);
...
void CGameObject::SetFbxScene(CFbxScene* pFbxScene)
{
	m_pFbxScene = pFbxScene;
	if (pFbxScene) pFbxScene->AddRef();
}
...
void CGameObject::Render(ID3D12GraphicsCommandList* pd3dCommandList, int index)
{
	OnPrepareRender();
	/*
	if (m_pMaterial)
	...
	pd3dCommandList->SetGraphicsRootDescriptorTable(index, m_d3dCbvGPUDescriptorHandle);
...
void CRotatingObject::Render(ID3D12GraphicsCommandList* pd3dCommandList, int index)
{
	CGameObject::Render(pd3dCommandList, index);
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CFbxScene::CFbxScene(FbxScene* pfbxScene)
{
	m_pfbxScene = pfbxScene;
}
...
CFbxScene::~CFbxScene()
{
	if (m_pfbxScene) ::ReleaseRenderInfoFromFbxNodeHierarchy(m_pfbxScene->GetRootNode());
...
void CMonsterObject::Render(ID3D12GraphicsCommandList* pd3dCommandList)
{
	OnPrepareRender();

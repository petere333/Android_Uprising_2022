	...
	* pd3dCommandList, void* pContext)
{
	//텍스처 생성
		...
		*/
		...
		CCubeMeshTextured* d_terrain2 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 850.0f, 100.0f, 3000.0f, 625.0f, 2600.0f);
		...
		CCubeMeshTextured* Terrain_Right_Wall_1_M = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 50.0f, 3000.0f, 4700.0f, 75.0f, 1500.0f);
		CCubeMeshTextured* Terrain_Right_Wall_1_H = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 900.0f, 3000.0f, 4700.0f, 550.0f, 1500.0f);
		...
		CCubeMeshTextured* Terrain_Right_Wall_2_M = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 50.0f, 2700.0f, 6500.0f, 75.0f, 1650.0f);
		CCubeMeshTextured* Terrain_Right_Wall_2_H = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 900.0f, 2700.0f, 6500.0f, 550.0f, 1650.0f);
		...
		CCubeMeshTextured* Terrain_Right_Wall_3_M = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 50.0f, 800.0f, 5600.0f, 75.0f, 400.0f);
		CCubeMeshTextured* Terrain_Right_Wall_3_H = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 900.0f, 800.0f, 5600.0f, 550.0f, 400.0f);
		...
		CCubeMeshTextured* Terrain_Right_Wall_4_M = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 2600.0f, 50.0f, 30.0f, 6915.0f, 75.0f, 15.0f);
		CCubeMeshTextured* Terrain_Right_Wall_4_H = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 2600.0f, 900.0f, 30.0f, 6915.0f, 550.0f, 15.0f);


		// 시작지역 문
		CCubeMeshTextured* terrain_door = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 200.0f, 200.0f, 100.0f, 2900.0f, 100.0f, 2600.0f);
		...
		// 오른쪽으로 향하는 문
		CCubeMeshTextured* terrain_tonglo_door = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 200.0f, 200.0f, 100.0f, 4100.0f, 100.0f, 2600.0f);
		CCubeMeshTextured* terrain_tonglo_door2 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 200.0f, 200.0f, 100.0f, 4300.0f, 100.0f, 2600.0f);
		...
		CCubeMeshTextured* terrain_Second_room_1_M = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 50.0f, 4000.0f, 8200.0f, 75.0f, 1000.0f);
		CCubeMeshTextured* terrain_Second_room_1_H = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 900.0f, 4000.0f, 8200.0f, 550.0f, 1000.0f);


		CCubeMeshTextured* terrain_Second_room_2 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 100.0f, 3550.0f, 4200.0f, 0.0f, 775.0f);
		CCubeMeshTextured* terrain_Second_room_2_1 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 100.0f, 350.0f, 4200.0f, 0.0f, 2825.0f);
		CCubeMeshTextured* terrain_Second_room_M_1 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 50.0f, 3550.0f, 4200.0f, 75.0f, 775.0f);
		CCubeMeshTextured* terrain_Second_room_M_2 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 50.0f, 350.0f, 4200.0f, 75.0f, 2825.0f);
		CCubeMeshTextured* terrain_Second_room_H_1 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 900.0f, 3550.0f, 4200.0f, 550.0f, 775.0f);
		CCubeMeshTextured* terrain_Second_room_H_2 = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 900.0f, 350.0f, 4200.0f, 550.0f, 2825.0f);
		CCubeMeshTextured* d_terrain_Second_room = new CCubeMeshTextured(pd3dDevice, pd3dCommandList, 30.0f, 850.0f, 100.0f, 4200.0f, 625.0f, 2600.0f);
		////////
		...
		CGameObject* S_Room_2_1 = new CGameObject(11);
		S_Room_2_1->SetMesh(0, terrain_Second_room_2_1);
		S_Room_2_1->SetMaterial(ppMaterials[1]);
		S_Room_2_1->SetPosition(0.0f, 0.0f, 0.0f);
		S_Room_2_1->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[74] = S_Room_2_1;

		CGameObject* S_room_M_1 = new CGameObject(11);
		S_room_M_1->SetMesh(0,terrain_Second_room_M_1);
		S_room_M_1->SetMaterial(ppMaterials[3]);
		S_room_M_1->SetPosition(0.0f, 0.0f, 0.0f);
		S_room_M_1->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[75] = S_room_M_1;


		CGameObject* S_room_M_2 = new CGameObject(11);
		S_room_M_2->SetMesh(0, terrain_Second_room_M_2);
		S_room_M_2->SetMaterial(ppMaterials[3]);
		S_room_M_2->SetPosition(0.0f, 0.0f, 0.0f);
		S_room_M_2->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[76] = S_room_M_2;


		CGameObject* S_room_H_1 = new CGameObject(11);
		S_room_H_1->SetMesh(0, terrain_Second_room_H_1);
		S_room_H_1->SetMaterial(ppMaterials[4]);
		S_room_H_1->SetPosition(0.0f, 0.0f, 0.0f);
		S_room_H_1->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[77] = S_room_H_1;


		CGameObject* S_room_H_2 = new CGameObject(11);
		S_room_H_2->SetMesh(0, terrain_Second_room_H_2);
		S_room_H_2->SetMaterial(ppMaterials[4]);
		S_room_H_2->SetPosition(0.0f, 0.0f, 0.0f);
		S_room_H_2->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[78] = S_room_H_2;

		CGameObject* S_room_1_M = new CGameObject(11);
		S_room_1_M->SetMesh(0, terrain_Second_room_1_M);
		S_room_1_M->SetMaterial(ppMaterials[3]);
		S_room_1_M->SetPosition(0.0f, 0.0f, 0.0f);
		S_room_1_M->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[79] = S_room_1_M;

		CGameObject* S_room_1_H = new CGameObject(11);
		S_room_1_H->SetMesh(0, terrain_Second_room_1_H);
		S_room_1_H->SetMaterial(ppMaterials[4]);
		...
		CGameObject* S_R_1_M = new CGameObject(11);
		S_R_1_M->SetMesh(0, Terrain_Right_Wall_1_M);
		S_R_1_M->SetMaterial(ppMaterials[3]);
		S_R_1_M->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_1_M->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[85] = S_R_1_M;


		CGameObject* S_R_1_H = new CGameObject(11);
		S_R_1_H->SetMesh(0, Terrain_Right_Wall_1_H);
		S_R_1_H->SetMaterial(ppMaterials[4]);
		S_R_1_H->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_1_H->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[86] = S_R_1_H;


		CGameObject* S_R_2_M = new CGameObject(11);
		S_R_2_M->SetMesh(0, Terrain_Right_Wall_2_M);
		S_R_2_M->SetMaterial(ppMaterials[3]);
		S_R_2_M->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_2_M->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[87] = S_R_2_M;


		CGameObject* S_R_2_H = new CGameObject(11);
		S_R_2_H->SetMesh(0, Terrain_Right_Wall_2_H);
		S_R_2_H->SetMaterial(ppMaterials[4]);
		S_R_2_H->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_2_H->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[88] = S_R_2_H;


		CGameObject* S_R_3_M = new CGameObject(11);
		S_R_3_M->SetMesh(0, Terrain_Right_Wall_3_M);
		S_R_3_M->SetMaterial(ppMaterials[3]);
		S_R_3_M->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_3_M->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[89] = S_R_3_M;

		CGameObject* S_R_3_H = new CGameObject(11);
		S_R_3_H->SetMesh(0, Terrain_Right_Wall_3_H);
		S_R_3_H->SetMaterial(ppMaterials[4]);
		S_R_3_H->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_3_H->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[90] = S_R_3_H;


		CGameObject* S_R_4_M = new CGameObject(11);
		S_R_4_M->SetMesh(0, Terrain_Right_Wall_4_M);
		S_R_4_M->SetMaterial(ppMaterials[3]);
		S_R_4_M->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_4_M->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[91] = S_R_4_M;


		CGameObject* S_R_4_H = new CGameObject(11);
		S_R_4_H->SetMesh(0, Terrain_Right_Wall_4_H);
		S_R_4_H->SetMaterial(ppMaterials[4]);
		S_R_4_H->SetPosition(0.0f, 0.0f, 0.0f);
		S_R_4_H->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[92] = S_R_4_H;

		CGameObject* D_SR = new CGameObject(11);
		D_SR->SetMesh(0, d_terrain_Second_room);
		D_SR->SetMaterial(ppMaterials[4]);
		D_SR->SetPosition(0.0f, 0.0f, 0.0f);
		D_SR->SetCbvGPUDescriptorHandlePtr(m_d3dCbvGPUDescriptorStartHandle.ptr + (::gnCbvSrvDescriptorIncrementSize * 0));
		m_ppObjects[93] = D_SR;

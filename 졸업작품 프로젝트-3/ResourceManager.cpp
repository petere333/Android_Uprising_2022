...
void ResourceManager::createTextures()
{
	...
	tex611 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex611->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/gun/idle.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex611);
	tex612 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex612->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/gun/attack.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex612);
	tex613 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex613->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/0.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex613);
	tex614 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex614->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/4.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex614);
	tex615 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex615->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/8.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex615);
	tex616 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex616->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/12.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex616);
	tex617 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex617->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/16.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex617);
	tex618 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex618->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/20.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex618);
	tex619 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex619->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/24.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex619);
	tex620 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex620->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/28.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex620);
	tex621 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex621->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/32.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex621);
	tex622 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex622->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/36.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex622);
	tex623 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex623->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/40.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex623);
	tex624 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex624->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/44.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex624);
	tex625 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex625->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/48.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex625);
	tex626 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex626->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/52.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex626);
	tex627 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex627->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/idle/56.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex627);
	tex628 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex628->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/player/radio/attack.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex628);

	tex629 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex629->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/0.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex629);
	tex630 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex630->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/1.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex630);
	tex631 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex631->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/2.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex631);
	tex632 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex632->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/3.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex632);
	tex633 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex633->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/4.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex633);
	tex634 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex634->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/5.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex634);
	tex635 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex635->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/6.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex635);
	tex636 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex636->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/7.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex636);
	tex637 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex637->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/8.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex637);
	tex638 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex638->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/9.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex638);
	tex639 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex639->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/10.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex639);
	tex640 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex640->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/att/11.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex640);
	
	tex641 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex641->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/0.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex641);
	tex642 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex642->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/1.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex642);
	tex643 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex643->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/2.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex643);
	tex644 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex644->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/3.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex644);
	tex645 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex645->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/4.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex645);
	tex646 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex646->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/5.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex646);
	tex647 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex647->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/6.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex647);
	tex648 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex648->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/7.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex648);
	tex649 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex649->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/8.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex649);
	tex650 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex650->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/9.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex650);
	tex651 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex651->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/10.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex651);
	tex652 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex652->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/11.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex652);
	tex653 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex653->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/12.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex653);
	tex654 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex654->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/13.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex654);
	tex655 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex655->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/14.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex655);
	tex656 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex656->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/15.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex656);
	tex657 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex657->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/shadow/char/enemy/gun/run/16.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex657);
	...
	tex676 = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	tex676->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/UI/stage/room_disabled.dds", RESOURCE_TEXTURE2D, 0);
	textures.push_back(tex676);

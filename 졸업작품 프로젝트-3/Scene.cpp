...
void CScene::createTextureData(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	textures[37]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/선반.dds", RESOURCE_TEXTURE2D, 0);
	textures[38] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[38]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/플라스틱빈.dds", RESOURCE_TEXTURE2D, 0);
	textures[39] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[39]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/창살.dds", RESOURCE_TEXTURE2D, 0);
	textures[40] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[40]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/감옥창살.dds", RESOURCE_TEXTURE2D, 0);
	textures[41] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[41]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/감옥창살2.dds", RESOURCE_TEXTURE2D, 0);
	textures[42] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[42]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/돌기둥받침.dds", RESOURCE_TEXTURE2D, 0);
	textures[43] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[43]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/기둥본체.dds", RESOURCE_TEXTURE2D, 0);
	textures[44] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[44]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/철벽.dds", RESOURCE_TEXTURE2D, 0);
	textures[45] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[45]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/발전소.dds", RESOURCE_TEXTURE2D, 0);
	textures[46] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[46]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/발전소2.dds", RESOURCE_TEXTURE2D, 0);
	textures[47] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[47]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/기둥텍스쳧.dds", RESOURCE_TEXTURE2D, 0);
	textures[48] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[48]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/롱탱크.dds", RESOURCE_TEXTURE2D, 0);
	textures[49] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[49]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/낡은벽.dds", RESOURCE_TEXTURE2D, 0);
	textures[50] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[50]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/뚱글이.dds", RESOURCE_TEXTURE2D, 0);
	textures[51] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[51]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/못뚤음.dds", RESOURCE_TEXTURE2D, 0);
	textures[52] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[52]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/뚤어라.dds", RESOURCE_TEXTURE2D, 0);
	...
	textures[54]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/잔해쓰.dds", RESOURCE_TEXTURE2D, 0);
	textures[55] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[55]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/두잔해.dds", RESOURCE_TEXTURE2D, 0);
	textures[56] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[56]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/세잔해.dds", RESOURCE_TEXTURE2D, 0);
	textures[57] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[57]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/네잔해.dds", RESOURCE_TEXTURE2D, 0);
	textures[58] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[58]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/다잔해.dds", RESOURCE_TEXTURE2D, 0);
	textures[59] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[59]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/톱날단검.dds", RESOURCE_TEXTURE2D, 0);
	textures[60] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[60]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/기계텍스.dds", RESOURCE_TEXTURE2D, 0);
	textures[61] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[61]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/팔트럭.dds", RESOURCE_TEXTURE2D, 0);
	textures[62] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[62]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/숨는벽.dds", RESOURCE_TEXTURE2D, 0);
	textures[63] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[63]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/들엄통.dds", RESOURCE_TEXTURE2D, 0);
	textures[64] = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	textures[64]->LoadTextureFromDDSFile(pd3dDevice, pd3dCommandList, L"res/dds/알미늄.dds", RESOURCE_TEXTURE2D, 0);
